...
function Temperature(value, unit, place, time) {
    const temp = {}
...
function Precipitation(value, precipitationType, unit, place, time) {
    const precipitation = {}
...
function Wind(value, direction, unit, place, time) {
    const wind = {}
...
function CloudCoverage(value, unit, place, time) {
...
function TemperaturePrediction(from, to, unit, place, time) {
...
function PrecipitationPrediction(from, to, typesVar, unit, place, time) {
...
function WindPrediction(from, to, directionsVar, unit, place, time) {
...
function CloudCoveragePrediction(from, to, unit, place, time) {
    let type = 'Cloud Coverage'
